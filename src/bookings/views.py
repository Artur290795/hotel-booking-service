"""HTTP-представления REST API для номеров и бронирований."""
...
class RoomView(APIView):
    """Создаёт, возвращает, изменяет и удаляет гостиничные номера."""
    ...
    def patch(self, request: Request, room_id: int):
        room = get_object_or_404(Room, id=room_id)
...
class BookingView(APIView):
    """Создаёт, возвращает и удаляет бронирования номеров."""
    ...
    def delete(self, request: Request, booking_id: int):
